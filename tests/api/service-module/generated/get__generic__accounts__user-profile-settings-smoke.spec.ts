...
// Source: GET /generic/accounts/user-profile-settings



test('smoke: GET /generic/accounts/user-profile-settings', async ({ request }) => {
  
  const response = await request.get(`${process.env.BASE_URL}/generic/accounts/user-profile-settings`);
