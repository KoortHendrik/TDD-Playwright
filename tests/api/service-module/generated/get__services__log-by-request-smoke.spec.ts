...
// Source: GET /services/log-by-request
...
test('smoke: GET /services/log-by-request', async ({ request }) => {
  
  const response = await request.get(`${process.env.BASE_URL}/services/log-by-request`);
