...
// Source: GET /services/statistics
...
test('smoke: GET /services/statistics', async ({ request }) => {
  
  const response = await request.get(`${process.env.BASE_URL}/services/statistics`);
  ...
  // Expected statuses from DSL: 200
