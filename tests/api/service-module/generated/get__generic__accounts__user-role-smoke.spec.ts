...
// Source: GET /generic/accounts/user-role



test('smoke: GET /generic/accounts/user-role', async ({ request }) => {
  
  const response = await request.get(`${process.env.BASE_URL}/generic/accounts/user-role`);
