...
// Source: GET /mocks/service-settings



test('smoke: GET /mocks/service-settings', async ({ request }) => {
  
  const response = await request.get(`${process.env.BASE_URL}/mocks/service-settings`);
