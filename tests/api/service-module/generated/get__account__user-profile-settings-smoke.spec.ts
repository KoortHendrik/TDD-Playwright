...
// Source: GET /account/user-profile-settings



test('smoke: GET /account/user-profile-settings', async ({ request }) => {
  
  const response = await request.get(`${process.env.BASE_URL}/account/user-profile-settings`);
